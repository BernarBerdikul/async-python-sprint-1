...
class DataCalculationTask:
    ...
    @staticmethod
    def calculate_rating(average_week_temp: float, average_without_precipitation: float) -> int:
    ...
    def calculation(self) -> dict[str, Any]:
        ...
        average_without_precipitation: float = self.average(data=week_day_hours_without_precipitation)
